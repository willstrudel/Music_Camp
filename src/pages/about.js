...
export default function About() {
  return (
    <main>
      <section className='pt-10 justify-center grid grid-col font-Jost font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl'>
        <h1 className="uppercase">About</h1>
      </section>
      <section className='top-60 justify-center grid grid-col p-6 font-Jost font-bold relative'>
